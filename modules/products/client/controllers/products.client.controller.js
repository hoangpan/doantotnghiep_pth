(function () {
  ...
  ProductsController.$inject = ['$scope', '$state', '$window', 'Authentication', 'productResolve','CatalogsService'];

  function ProductsController ($scope, $state, $window, Authentication, product, CatalogsService) {
    var vm = this;
